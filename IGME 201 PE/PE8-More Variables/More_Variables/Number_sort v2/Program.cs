...
namespace NumberSortV1
{
    ...
    {
        //decare a delegate type that returns a double and our datatype is the lowestorhighest function and it accepts array of doubles

        delegate double loworhigh(double[] a);
        // Method: Main()
        ...
        start:
            ...
            {
                lowestorhighest = new loworhigh(FindHighestValue);
            }
        ...
        static double FindLowestValue(double[] array) //if we want to do decsigin order do find highest values instead 
        {
        ...
        // find the lowest value in the array of ints
        // the method "signature" defines a method and consists of the return type (double) and method arguments (double[] array) 
        static double FindHighestValue(double[] array) //if we want to do decsigin order do find highest values instead 
        {
            // define return value (because it returns a double from the array)
            double returnVal;
            ...
            {
                // if the current value is less than the saved lowest value
                if (thisNum > returnVal) //change this to the highest value and return it and save it as the highest value
                {
                    // save this as the lowest value and move on 
                    returnVal = thisNum;
                }
