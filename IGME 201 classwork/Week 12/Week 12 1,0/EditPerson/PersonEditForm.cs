...
namespace EditPerson
{
    public partial class PersonEditForm : Form
    {
        ...
        public PersonEditForm(Person person, Form parentForm )
        {
            ...
            if(person is Student student)  //c# gives us a shortcut to declare the student reference variable is person is a student
            //if its a student then c# sets our variable to a student**
            //student variable is only within scope of code block for our conditonal just like our original code**
            //if( person.GetType() == typeof(Student) )
            {
                this.typeComboBox.SelectedIndex = 0;

                //above if statement does this line and first conditonal in one line**
