...
namespace FavoriteColorAndNumber
{
    ...
    static internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //basically a backwards while loop**
            //is there a certain situation where we would want to use this instead of a regular loop**
            //we usually initizlize variables and not just declare them and initizilaize later**
            do
            {
                sFavoriteNumber = Console.ReadLine();
            ...
            do
            {
                ...
                try
                {
                    ...
                    //but if it's "42hi" then it will not because there are letters within it**
                    //with parsing which data types can we convert to with it (int.,float?)** (parse only converts strings right)**
                }
                catch
                {
                    Console.WriteLine("Please enter an integer.");
            ...
            do
            {
                ...
                //out nFav is basically set equal to sFav??**
            ...
            // code blocks and variable scope
            {
                ...
                // int myInt = 5;
                //but if it was defined in child then we defined another out in parent it would work because parent**
                //can;t access from within the child**
                ...
                //and give a proper action for that option chosen**
            {
                ...
                default:
                    Console.ForegroundColor = ConsoleColor.White; //usually put a default just in case**
                    break;
                    //what if we did not put break**
                    //how to comment highlighted code and let the code autofill for us while we are writing**
            }
            ...
            //for loops whats the difference between putting i++ and ++i, will it still increment the same**
            ...
            //      2. condition check:  (i < favNum) what to check at the beginning of the loop each time it loops (including the first time)
                    //can we also have multiple conditions with , seperations or no**
            //
            ...
            //          so that if you need to do something N times, you may have to --i before the "continue" to repeat the same value of i. (example)**
            //
