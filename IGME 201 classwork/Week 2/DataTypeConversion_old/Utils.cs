...
// But it will add a new class of the name of the file (can we name it something else or does it have to be the same name as the parent file)**
// the main method is only in the parent file**
...
// is available across all of our sources
...
//along with "partial" should our namepscaes also be the same**
