...
namespace NumberSortV1
{
    ...
    static class Program
    {
        ...
        //do we have to know how to do all of this*****
        ...
        start:
            ...
            // a double used for parsing the current array element into a double**
            double nThisNumber;
            ...
            for( nCntr = 0; nCntr < sNumbers.Length; ++nCntr)
            {
                ...
                sNumbers[nCntr] = ""; //changes the contents to an empty string**
            }
            ...
            foreach (string sThisNumber in sNumbers)
            {
                ...
                //sThisNumber = ""; because it is already going to be equal to each part of the array as we go through it**

                // if the length of this string is 0 (ie. they typed 2 spaces in a row)
                if (sThisNumber.Length == 0) 
                {
                    // skip it (if the current value we are in the array is equal to 0 then we skip that element and go back to the
                ...
                catch
                {
                    ...
                    Console.WriteLine($"Number #{nUnsortedLength + 1} is not a valid number."); //why do we add 1 to it**
                    //if its not valid it does not add it and skips the element and moves on to the next one**
                    //everytime we go back to the beginnning of the loop it goes to the next element in the array until we reach the end for the foreach loop**
            ...
            aUnsorted = new double[nUnsortedLength]; //what is this statement exactly saying**
            ...
            foreach (string sThisNumber in sNumbers)
            {
                ...
                // increment the array index to go to the next index and add an element??**
                nUnsortedLength++;
            }
        ...
        // the method "signature" defines a method and consists of the return type (double) and method arguments (double[] array) which is**
        ...
        // remove the first instance of a value from an array go over this**
