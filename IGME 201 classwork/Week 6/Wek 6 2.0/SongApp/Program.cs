...
//and we have to have the same namespace though to access the same dll (they dont have to but its good practice and one project = same namespace name through the project)
